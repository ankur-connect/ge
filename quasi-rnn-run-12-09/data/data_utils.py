...
def prepare_train_batch(seqs_x, seqs_y, maxlen=None):
    ...
    #print ("lengths_y", lengths_y)

    #at least for the first several runs, it's always a pad token
    ...
    if maxlen is not None:
        ...
        #print ("len seqs_x", len(seqs_x))
        #print ("len seqs_y", len(seqs_y))
    ...
    #print "starting loop through s_x and s_y"
   
    for idx, [s_x, s_y] in enumerate(zip(seqs_x, seqs_y)):
        #print ("idx", idx)
        #print ("lengths_x[idx]", lengths_x[idx])
        #print ("x within indexes", x[idx, :lengths_x[idx]])
    ...
    #print "done looping through s_x and s_y"
