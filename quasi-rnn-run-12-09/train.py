...
def train(config):
    ...
    for epoch_idx in xrange(config.max_epochs):
        ...
        for source_seq, target_seq in train_set:    
            ...
            #print ("source seq", source_seq)

            #print ("target seq", target_seq[0])
            ...
            if model_state['train_steps'] % config.display_freq == 0:
                ...
                print >>thefile, 'Epoch ', model_state['epoch'], 'Step ', model_state['train_steps'], \
                ...
                # thefile.write('Epoch ', model_state['epoch'], 'Step ', model_state['train_steps'], \
                #       'Perplexity {0:.2f}'.format(avg_perplexity), 'Step-time {0:.2f}'.format(step_time), \
                #       '{0:.2f} sents/s'.format(sents_per_sec), '{0:.2f} words/s'.format(words_per_sec))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_enc_symbols', type=int, default=125)
    parser.add_argument('--num_dec_symbols', type=int, default=125)
